...
type ExampleClient interface {
	ExampleRPC(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *exampleClient) ExampleRPC(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/hello.Example/ExampleRPC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	ExampleRPC(context.Context, *Request) (*Response, error)
...
func (UnimplementedExampleServer) ExampleRPC(context.Context, *Request) (*Response, error) {
...
func _Example_ExampleRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.Example/ExampleRPC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).ExampleRPC(ctx, req.(*Request))
	}
